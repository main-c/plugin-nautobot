        ...
        return [
            {
                ...
                "url": reverse(
                    "plugins:nautobot_graph:circuit_detail_tab",
        ...
        return [
            {
                ...
                "url": reverse(
                    "plugins:nautobot_graph:device_detail_tab_1",
                    kwargs={"pk": self.context["object"].pk},
                ),
            },
            {
                ...
                "url": reverse(
                    "plugins:nautobot_graph:device_detail_tab_2",
                    kwargs={"pk": self.context["object"].pk},
                ),
            },
        ]
...
class ExampleModelContent(TemplateExtension):
    model = "nautobot_graph.examplemodel"
    template_name = "nautobot_graph/panel.html"
